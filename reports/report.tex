...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{merged\_video}\SpecialCharTok{$}\NormalTok{step\_position }\OtherTok{\textless{}{-}} 
  \FunctionTok{as.character}\NormalTok{(merged\_video}\SpecialCharTok{$}\NormalTok{step\_position)}
\end{Highlighting}
\end{Shaded}
