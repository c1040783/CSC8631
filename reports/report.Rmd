...
\hfill\break
In this project, we are going to consider several files related to our observations only. The files are :
...
We are going to use these files to answer question number three and four

\noindent
Other files are going to be dropped since they are unrelated to our questions.
